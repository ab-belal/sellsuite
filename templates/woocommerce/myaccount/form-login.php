			...
			<?php endif; ?>
				...
				<form id="sellix-login-form" class="woocommerce-form woocommerce-form-login login" method="post" onsubmit="return false;" novalidate>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<span class="field-error username-error" style="display:none"></span>
					</p>
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="password"><?php esc_html_e( 'Password', 'woocommerce' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'woocommerce' ); ?></span></label>
						<input class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="password" id="password" autocomplete="current-password" required aria-required="true" />
						<span class="field-error password-error" style="display:none"></span>
					</p>
					...
					<p class="signup-link">
						<a href="#">
							<?php echo __( 'Have not an account? <strong>Sign Up</strong>', 'woocommerce' ); ?>
						</a>
					</p>
			...
			<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
				...
				<div class="u-column2 col-2 sellix-signup-column">
					...
					<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
						...
						<p class="login-link">
							<a href="#">
								<?php echo __( 'Aready have an account? <strong>Login</strong>', 'woocommerce' ); ?>
							</a>
						</p>
